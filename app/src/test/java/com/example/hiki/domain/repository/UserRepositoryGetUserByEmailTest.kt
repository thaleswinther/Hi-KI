...
class UserRepositoryGetUserByEmailTest {
    ...
    @Test
    fun `test get user by email`() = runBlocking {
    ...
    @Test
    fun `test get user by email with non-existent email`() = runBlocking {
        val retrievedUser = userRepository.getUserByEmail("nonexistent@gmail.com")
